...
export function SalesDonutChart() {
  ...
  useEffect(() => {
    ...
    // Mock data
    const data = [
      { label: "Direct", value: 38.6, color: "#3b82f6" }, // Changed from #8b5cf6
      { label: "Affiliate", value: 22.5, color: "#60a5fa" }, // Changed from #3b82f6
      { label: "Sponsored", value: 30.8, color: "#93c5fd" }, // Changed from #6366f1
      { label: "E-mail", value: 8.1, color: "#bfdbfe" }, // Changed from #14b8a6
    ]
